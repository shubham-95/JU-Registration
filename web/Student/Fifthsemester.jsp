...
<html>
    ...
    function noBack() { window.history.forward(); }
        ...
        <link href="_css/fifth.css" rel="stylesheet" type="text/css" />
        ...
        <script>
           ...
           var name=document.fifth.studentname.value;  
           var fathername=document.fifth.fname.value;  
           var regno=document.fifth.reg.value;
           var course=document.fifth.crse.value;
           var branch=document.fifth.branch.value;
           var section=document.fifth.section.value;
           //var scholarship=document.fifth.scholarship.value;
           var fee=document.fifth.fee.value;
           //var hosteln=document.fifth.hosteln.value;
           var tgname=document.fifth.tgname.value;
           var op1=document.fifth.op1.value;
           var op2=document.fifth.op2.value;
           var op3=document.fifth.op3.value;
           var op4=document.fifth.op4.value;
           var op5=document.fifth.op5.value;
           var op6=document.fifth.op6.value;
           var op7=document.fifth.op7.value;
           var op8=document.fifth.op8.value;
           var op9=document.fifth.op9.value;
           var op10=document.fifth.op10.value;
           var op11=document.fifth.op11.value;
           var op12=document.fifth.op12.value;
           var padd=document.fifth.paddress.value;
           var ladd=document.fifth.laddress.value;
           var pname=document.fifth.pname.value;
           var mobilep=document.fifth.mobilep.value;
           var emailp=document.fifth.emailp.value;
           var smob=document.fifth.smob.value;
           var semail=document.fifth.semail.value;
...
<p><i>Approved by UGC</p><br><font size="2">Estd. Under<br>Act No. 15-2012 of Govt. of Rajasthan</i></p>
        ...
        <div align="left" style="width:100%;height:100%">
                 ...
                 <pre>
                 <form action="submit.jsp" name="fifth" method="post" onsubmit="return validateform()">
