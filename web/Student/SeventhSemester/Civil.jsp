<%-- 
    Document   : Civil
    Created on : 8 Jan, 2017, 3:47:05 AM
...
11. Permanent address  <input type="text" name="paddress"  onkeypress="submitOnEnter(event);" type="text" style="height:20px;border: 1px solid #CCC; width: 500px;" class="input2 width180" maxlength="100"/>        

12. Local Address      <input type="text" name="laddress"  onkeypress="submitOnEnter(event);" type="text" style="height:20px;border: 1px solid #CCC; width: 500px;" class="input2 width180" maxlength="100"/>

13. Contact Details:Father/Guardian
