<%-- 
    Document   : Studentcpanel
    Created on : 8 Jan, 2017, 6:54:22 PM
...
<div align="center">
               <form action="Studentlogindetails.jsp">
                   <input type="submit" value="Show Login Details" style="background:#a12d33;color:#ffffff;">
                   </form>
        <form action="Studentformdetails.jsp">
                   <input type="submit" value="Show Form Details" style="background:#a12d33;color:#ffffff;">
                   </form>
               </div>
